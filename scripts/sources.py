...
SOURCES = {
    ...
    "onco":     {"label": "腫瘤護理學會",         "url": "https://www.onst.org.tw/",             "credits": ["nurse", "np"],      "login": True},
    "perio":    {"label": "手術全期護理學會",     "url": "https://www.torna.org.tw/",            "credits": ["nurse"],            "login": True},
    "critical": {"label": "急重症護理學會",       "url": "https://www.taccn.org.tw/",            "credits": ["nurse", "np"],      "login": False},
    "ob":       {"label": "婦產科護理學會",       "url": "",                                     "credits": ["nurse"],            "login": True},
