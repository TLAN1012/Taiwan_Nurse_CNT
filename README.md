...
本專案的**程式碼**（`index.html`、`scripts/`、workflow 等）以 **MIT License** 授權，
歡迎自由使用、修改與散布。

⚠️ **重要：授權範圍僅限程式碼。** 本站聚合之**課程資料著作權屬各主辦公會／學會所有**，
不在本授權範圍內；本專案僅作為便民彙整工具，並附上各來源之官方連結。若各單位不希望
其課程資訊被彙整，請來信告知，將予以移除。

## 免責聲明

本站為便民查詢工具，課程資料著作權屬各主辦單位所有。實際場地、學分數與積分別
以主辦公會／學會之公告為準。資料以低頻率（每週一次）擷取自各單位之公開頁面。
